...
def render_404_page(cat_image_url):
    ...
    <body>
        <div class="container error-container text-center">
            <h1 class="display-4 text-danger">404 - Página Não Encontrada</h1>
            <p class="lead">Desculpe, não conseguimos encontrar a página que você está procurando.</p>
            <p>Mas aqui está uma foto de um gato para alegrar seu dia!</p>
...
def main():
    ...
    # Renderiza a página 404 com a imagem do gato
    render_404_page(cat_image_url)
